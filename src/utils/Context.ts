...
import { ContextNotFound, MissingContextFileError, MissingCurrentContextError } from '../errors/ContextError';

const { readFile, writeFile } = fs;
const CONTEXT_FILENAME = process.env.CONTEXT_FILENAME || '.otto';
